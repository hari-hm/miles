...
The router process generates a session_id with :func:`new_session_id`, maps it
to an owning worker with :func:`worker_index_for_session`, and dispatches over
...
Stdlib only — a headless worker / router imports this without FastAPI.
"""
